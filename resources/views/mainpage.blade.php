        ...
        <div class="container">
          ...
          <div class="col-md-12 ftco-animate text-center">
          	<div class="text mb-5 pb-3">
	            <h1 class="mb-3">Welcome To Moonlit Lagoon Hotel</h1>
        ...
        <div class="container">
          ...
          <div class="heading-section heading-section-wo-line pt-md-5 pl-md-5 mb-5">
              <div class="ml-md-0">
                ...
                <h2 class="mb-4">Welcome to Your Perfect Getaway!</h2>
            </div>
          </div>
          <div class="pb-md-5">
                        <p>Indulge in the epitome of sophistication and comfort at our hotel, where every moment is curated to perfection.</p>
                        <p>From the refined ambiance to our impeccable service, we offer an experience that redefines luxury. Whether for business or leisure, let the charm of our exquisite surroundings envelop you in serenity and style.
                        <p>Our elegantly designed rooms and suites offer the perfect retreat, adorned with premium amenities and thoughtful touches that ensure your stay is as comfortable as it is stylish
                        <p>Welcome to a stay like no other, where elegance meets excellence. </p>
      ...
      <div class="col-md-3 d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services py-4 d-block text-center">
          ...
          <div class="media-body p-2 mt-2">
            ...
            <p>Our front desk is at your service around ensuring your needs efficiently</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services py-4 d-block text-center">
          ...
          <div class="media-body p-2 mt-2">
            ...
            <p> Indulge in exquisite dining and refreshing drinks in a stylish setting</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 d-flex align-sel Searchf-stretch ftco-animate">
        <div class="media block-6 services py-4 d-block text-center">
          ...
          <div class="media-body p-2 mt-2">
            ...
            <p>Seamless transportation to and from your destination, hassle-free</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services py-4 d-block text-center">
          ...
          <div class="media-body p-2 mt-2">
            ...
            <p>Relax and rejuvenate in our luxurious, tranquil spa accommodations</p>
          </div>
        </div>
      </div>
    </div>
