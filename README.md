...
**User Profile** 
- The system allows customers to create and login to their account using their name, email, password and contact information. Customers can manage their user profiles, providing a convenient and personalized experience. Customers can then read and access their profiles, including viewing their booking history. The update feature allows customers to edit their personal details such as name, email and phone numbers. In case of account deactivation, customers can delete their accounts. 

**Bookings** 
- The key features of the system is its booking functionality, which allows customers to reserve hotel rooms seamlessly. Customers can book their desired rooms by selecting dates, room type and the number of guests. Upon successful booking, customers can read and view the booking details such as dates and room type. Furthermore, customers can update their booking details by changing the dates or the number of guests. Customers can also cancel their booking if they want to. On the administrative side, the hotel admin can manually add and delete booking. 

**Review and Ratings**
- To enhance customers' trust and gather valuable feedback, the system includes a reviews and ratings features. Customers can rate their experience using a 1-5 star rating system and leave written reviews on their stay. If the customer want to update their reviews, they may do so within a limited time frame. These reviews will be displayed on the review and ratings section to assist future guests in making decisions.

**Payments**
- The payment system ensures that customers can make payments for their bookings using multiple payment options, including credit cards, debit cards and online banking, providing flexibility. Upon booking confirmation, customers will enter their bank details, including the name on the bank card and the card number to process the payment. Upon successful payment, the system will provides receipts as a confirmation of successful payments for the customers to view. However, the customer can cancel payments before confirmation if they change their mind last minute. 
